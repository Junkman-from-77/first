...
<body>
    ...
    <header>
        ...
        <h1>Московский метрополитен: формирование составов и информаторы по состоянию на окт-2002.</h1>
        <form action="" method="GET">
            <label for="year">Выбрать год: </label>
            <select onchange="window.location.href=this.options[this.selectedIndex].value">
                <option selected VALUE="http://ilyawbyand.temp.swtest.ru/metro/2002/index.php">2002</option>
    ...
    <section>
        <?php
            ...
            $query = 'SELECT line_name, depo, informator FROM two'; 
