...
<body>
    ...
    <header>
        ...
        <h1>Московский метрополитен: формирование составов и информаторы по состоянию на окт-2006.</h1>
        <form action="" method="GET">
            ...
            <select onchange="window.location.href=this.options[this.selectedIndex].value">
                ...
                <option selected VALUE="http://ilyawbyand.temp.swtest.ru/metro/2006/index.php">2006</option>
