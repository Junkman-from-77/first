...
<body>
    ...
    <header>
        ...
        <h1>Московский метрополитен: формирование составов и информаторы по состоянию на апр-2004.</h1>
        <form action="" method="GET">
            ...
            <select onchange="window.location.href=this.options[this.selectedIndex].value">
                ...
                <option selected VALUE="http://ilyawbyand.temp.swtest.ru/metro/2004/index.php">2004</option>
                <option VALUE="http://ilyawbyand.temp.swtest.ru/metro/2005/index.php">2005</option>
    ...
    <section>
        <?php
            ...
            $query = 'SELECT line_name, depo, informator FROM four'; 
