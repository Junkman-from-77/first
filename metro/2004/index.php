...
<body>
    ...
    <header>
        ...
        <h1>Московский метрополитен: формрование составов и информаторы по состоянию на апр-2004.</h1>
        <form action="" method="GET">
            <label for="year">Выбрать год: </label>
            <select onchange="window.location.href=this.options[this.selectedIndex].value">
                <option VALUE="http://f0799572.xsph.ru/metro/2002/index.php">2002</option>
                <option selected VALUE="http://f0799572.xsph.ru/metro/2004/index.php">2004</option>
