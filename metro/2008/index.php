...
<body>
    ...
    <header>
        ...
        <h1>Московский метрополитен: формирование составов и информаторы по состоянию на янв-2008.</h1>
        <form action="" method="GET">
            ...
            <select onchange="window.location.href=this.options[this.selectedIndex].value">
                ...
                <option selected VALUE="http://ilyawbyand.temp.swtest.ru/metro/2008/index.php">2008</option>
            </select>
        </form>
    </header>
    <section>
