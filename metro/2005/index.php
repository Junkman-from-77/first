...
<body>
    <div class="wrapper">
    <header>
        <p>На главную: <a  href="http://ilyawbyand.temp.swtest.ru/">http://ilyawbyand.temp.swtest.ru/</a></p>
        <h1>Московский метрополитен: формирование составов и информаторы по состоянию на фев-2005.</h1>
        <form action="" method="GET">
            <label for="year">Выбрать год: </label>
            <select onchange="window.location.href=this.options[this.selectedIndex].value">
                <option VALUE="http://ilyawbyand.temp.swtest.ru/metro/2002/index.php">2002</option>
                <option VALUE="http://ilyawbyand.temp.swtest.ru/metro/2004/index.php">2004</option>
                <option selected VALUE="http://ilyawbyand.temp.swtest.ru/metro/2005/index.php">2005</option>
                <option VALUE="http://ilyawbyand.temp.swtest.ru/metro/2006/index.php">2006</option>
                <option VALUE="http://ilyawbyand.temp.swtest.ru/metro/2008/index.php">2008</option>
            </select>
        </form>
    </header>
    <section>
        <?php
            ...
            $query = 'SELECT line_name, depo, informator FROM five'; 
