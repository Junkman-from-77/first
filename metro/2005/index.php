...
<body>
    ...
    <header>
        ...
        <h1>Московский метрополитен: формрование составов и информаторы по состоянию на фев-2005.</h1>
        <form action="" method="GET">
            ...
            <select onchange="window.location.href=this.options[this.selectedIndex].value">
                ...
                <option selected VALUE="http://f0799572.xsph.ru/metro/2005/index.php">2005</option>
                <option VALUE="http://f0799572.xsph.ru/metro/2006/index.php">2006</option>
                <option VALUE="http://f0799572.xsph.ru/metro/2008/index.php">2008</option>
            </select>
        </form>
    </header>
    <section>
